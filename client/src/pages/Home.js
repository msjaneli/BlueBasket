        ...
        return (
            <div>
              ...
              <div id="page2">
                ...
                <Row>
                  <Col><div><p>We live a world where food waste and hunger coexist. At the end of the day, restaurants are forced to trash uneaten leftovers. At the same time, residents who cannot afford food go hungry.</p></div>
                  ...
                  <div><p>What if there was a way we could redistribute this food in a way that mutually benefits everyone involved?</p></div></Col>
                  <Col><div><p>We work with restaurants on Duke campus to provide alternative options for food waste. Towards closing time, restaurants pack their leftovers into prepped meal boxes and list them on our platform to sell for a discounted price. </p></div>
