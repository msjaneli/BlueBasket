...
class ShelterCheckout extends Component {
    constructor(props){
        super(props);
    ...
    render (){
        ...
        let selectPayment = (
            <Card body>
                <Row>
                    <Col>
                        <Button className="option-button" variant="donationsbalance">Donations Balance</Button>
                    </Col>
                </Row>

                <style type="text/css">
                    {`
                        .btn-donationsbalance {
...
export default connect(mapStateToProps, mapDispatchToProps)(ShelterCheckout);
