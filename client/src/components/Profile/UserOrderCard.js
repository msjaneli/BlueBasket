    ...
    render() {
        return(
          <Card className="order-card">
            ...
            <Col><p className="user-order-card-quantity">Quantity: {this.props.order.quantities[this.props.orderIdex]}</p></Col>
            ...
            <Row><Col className="text-left"><p className="user-order-card-details">Description: {this.state.listing.description}</p></Col>
            </Row>
            <Row>
